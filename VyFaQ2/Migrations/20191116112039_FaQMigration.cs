    ...
    public partial class FaQMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserQuestion", x => x.Email);
                });
            ...
            migrationBuilder.InsertData(
                table: "UserQuestion",
                columns: new[] { "Email", "Name", "QuestionText" },
                values: new object[] { "Funnygai@Funneh.com", "Funny McFunnison", "How do you uninstall the Vy app" });
        }
